...
set :domain_name, "sylvansport.com" # should be something like mydomain.com
set :user, 'scullysylvan' # Webbynode username
set :domain, '74.207.228.91' # Webbynode IP address
...
set :applicationdir, "/home/sylvansport.com" # set this to where the application will be deployed
