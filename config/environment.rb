...
Radiant::Initializer.run do |config|
  ...
  config.action_controller.session = {
    :key => '_sylvansport_session',
    :secret      => '7abe2b5aef503995e01a2cd18d86908c3eb5069b'
  }
...
ActionMailer::Base.smtp_settings = {
  ...
  :port => 587,
  :user_name => "sylvansportcontest@gmail.com",
  :password => "sylv@nsp0rtc0nt3st",
